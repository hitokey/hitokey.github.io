...
Então começamos iniciando um servidor http simples, com uma função dinamica que pegar a query_string é diz um Hello, caso não term a query\_string, diz hello, world.
