...
[[./imagens/localhost.png][./imagens/localhost.png]]
...
**** GET Request
   ...
   O método get e post é exencial para a comunicação HTTP, como vimos no *GET Simples - Hello World*, usamos o método GET, quando manipulamos a QUERY_STRING, mas vejamos novamente outra aplicação utilizando o método Query.
...
[[./imagens/cgi_clean.png][/imagens/cgi_clean.png]]
...
[[./imagens/cgi_python.png][./imagens/cgi_python.png]]
...
[[./imagens/cgi_lisp.png][./imagens/cgi_lisp.png]]
